        ...
        <div className="container px-5 py-5 mx-auto">
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="scroll-m-20 text-lg font-semibold tracking-tight text-myBlue mb-3">
                Important Links
              </h2>
              ...
              <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                  <label
                    ...
                    className="text-xs font-semibold tracking-tight text-myBlue 
            hover:text-myBlue/80"
                  >
                    Your Email Here
                  </label>
              ...
              focus:ring-2 focus:ring-mybiscuiti focus:border-myBlue text-base outline-none
               text-myBlue py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                ...
                <button
                  className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-myWhite bg-myBlue border-0 
          py-2 px-6 focus:outline-none hover:bg-myBlue/85 rounded"
              ...
              <p
                className="mt-2 md:text-left text-center text-xs font-semibold tracking-tight text-myBlue 
            hover:text-myBlue/80"
              >
